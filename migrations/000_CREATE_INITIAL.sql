...
CREATE TABLE `City` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cities_state_id` (`stateId`) -- CONSTRAINT `fk_cities_state_id` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `Address` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_addresses_city_id` (`cityId`) -- CONSTRAINT `fk_addresses_city_id` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `Barbershop` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_barbershop_address_id` (`addressId`) -- CONSTRAINT `fk_barbershops_address_id` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `Employee` (
  ...
  KEY `idx_employee_barbershop_id` (`barbershopId`) -- CONSTRAINT `fk_employees_role_id` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`),
...
CREATE TABLE `Category` (
  ...
  -- `updated_at` timestamp DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_category_barbershop_id` (`barbershopId`) -- CONSTRAINT `fk_categories_barbershop_id` FOREIGN KEY (`barbershop_id`) REFERENCES `barbershops` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `Service` (
  ...
  KEY `idx_service_barbershop_id` (`barbershopId`) -- CONSTRAINT `fk_services_category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
...
CREATE TABLE `EmployeeService` (
  ...
  KEY `idx_employee_services_service_id` (`serviceId`) -- CONSTRAINT `fk_employees_services_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`),
...
CREATE TABLE `Customer` (
  ...
  -- `updated_at` timestamp DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_customer_barbershop_id` (`barbershopId`) -- CONSTRAINT `fk_customers_barbershop_id` FOREIGN KEY (`barbershop_id`) REFERENCES `barbershops` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `Appointment` (
  ...
  KEY `idx_appointment_employee_service_id` (`employeeServiceId`) -- CONSTRAINT `fk_appointments_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`),
  -- CONSTRAINT `fk_appointments_employee_service_id` FOREIGN KEY (`employee_service_id`) REFERENCES `employees_services` (`id`),
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

CREATE TABLE `User` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `barbershopId` int unsigned DEFAULT NULL,
